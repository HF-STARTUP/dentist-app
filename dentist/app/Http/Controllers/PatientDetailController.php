...
class PatientDetailController extends Controller
{
    ...
    function __construct()
    {
        ...
        $this->middleware('permission:patient-detail-create', ['only' => ['create','store','odontogram','odontogramRemove']]);
    ...
    public function odontogram(Request $request, User $user)
    {
      ...
      return redirect('patient-details/' . $user->id . '?odontogram=show')->with('success', trans('Patient Updated Successfully'));
    }

    public function odontogramRemove(Odontogram $odontogram)
    {
      $odontogram->delete();
      return redirect('patient-details/' . $odontogram->user_id . '?odontogram=show')->with('success', trans('Deleted Successfully'));
    }
