...
Route::group(['middleware' => ['auth']], function() {
    ...
    Route::get('/patient-details/{odontogram}/odontogram', [App\Http\Controllers\PatientDetailController::class, 'odontogramRemove'])->name('patient-details.odontogram');
    Route::post('/patient-details/{user}/odontogram', [App\Http\Controllers\PatientDetailController::class, 'odontogram'])->name('patient-details.odontogram');
