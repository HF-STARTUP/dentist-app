                ...
                <div class="card-body">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link {{ request('odontogram') ? '' : 'active' }}" id="home-tab" data-toggle="tab" data-target="#home"
                                type="button" role="tab" aria-controls="home" aria-selected="true">Info</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link {{ request('odontogram') ? 'active' : '' }}" id="profile-tab" data-toggle="tab" data-target="#profile"
                                type="button" role="tab" aria-controls="profile"
                                aria-selected="false">Odontogram</button>
                        </li>
                    </ul>
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade {{ request('odontogram') ? '' : 'show active' }}" id="home" role="tabpanel" aria-labelledby="home-tab">
                            <div class="row">
                                <div class="col-md-4">
                        ...
                        <div class="tab-pane fade {{ request('odontogram') ? 'show active' : '' }}" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                            <div class="row">
                                <div class="col-md-12">
                                        ...
                                        <svg version="1.1" xmlns="http://www.w3.org/2000/svg"
                                            ...
                                            <g id="toothLabels">
                                                ...
                                                <text id="lbl15" transform="matrix(1 0 0 1 315.3335 275.3333)"
                                                    font-family="'Avenir-Heavy'" font-size="21px">27</text>
                                                <text id="lbl14" transform="matrix(1 0 0 1 311.3335 236)"
                                                    font-family="'Avenir-Heavy'" font-size="21px">26</text>
                                                <text id="lbl13" transform="matrix(1 0 0 1 300.3335 200.6667)"
                                                    font-family="'Avenir-Heavy'" font-size="21px">25</text>
                                                <text id="lbl12" transform="matrix(1 0 0 1 286.6669 172)"
                                                    font-family="'Avenir-Heavy'" font-size="21px">24</text>
                                                <text id="lbl11" transform="matrix(1 0 0 1 270.2269 142.439)"
                                                    font-family="'Avenir-Heavy'" font-size="21px">23</text>
                                                <text id="lbl10" transform="matrix(1 0 0 1 247.5099 118.9722)"
                                                    font-family="'Avenir-Heavy'" font-size="21px">22</text>
                                            ...
                                            <g id="dmftLabels">
                                                <text id="txtTooth32" transform="matrix(1 0 0 1 5.0001 386.3778)"
                                                    font-family="'MyriadPro-Regular'" font-size="16px"></text>
                                            ...
                                            <g id="Spots">
                                                <polygon id="Tooth48" onclick="reply_click(this.id)" fill="white"
                                                    data-key="32"
                 ...
                 80.7,375 73.7,371.3 	">
                                                ...
                                                <polygon id="Tooth47" onclick="reply_click(this.id)" fill="white"
                                                    data-key="31"
                 ...
                 46.7,476.7 37.7,446.3 39.7,438.3 43.3,432 49,426.7 56,424.7 65,424.7 	">
                                                ...
                                                <polygon id="Tooth46" onclick="reply_click(this.id)" fill="white"
                                                    data-key="30"
                 ...
                 60.3,529.7 56.3,523.7 51.7,511 47.7,494.7 47.7,488.3 50.3,483.3 55,479.7 67,476.7 	">
                                                ...
                                                <polygon id="Tooth45" onclick="reply_click(this.id)" fill="white"
                                                    data-key="29"
                 ...
                 98.3,578.3 88,579 82,575 75,565 69.3,552.3 67.3,542 69.7,536 74.3,531.7 84.3,528.3 	">
                                                ...
                                                <path id="Tooth44" onclick="reply_click(this.id)" fill="white"
                                                    data-key="28"
                                                ...
                                                <polygon id="Tooth43" onclick="reply_click(this.id)" fill="white"
                                                    data-key="27"
                 ...
                 133.3,641.3 128.7,634.7 128.7,629 132.7,621.3 137.7,615 143.7,611 149.7,610 	">
                                                ...
                                                <polygon id="Tooth42" onclick="reply_click(this.id)" fill="white"
                                                    data-key="26"
                 ...
                 168,656.3 159.3,649.7 156.7,644 162,639.3 	">
                                                ...
                                                <polygon id="Tooth41" onclick="reply_click(this.id)" fill="white"
                                                    data-key="25"
                 ...
                 190.3,662.7 193,657.3 199.7,647.3 207,638 210.7,635.5 	">
                                                ...
                                                <path id="Tooth31" onclick="reply_click(this.id)" fill="white"
                                                ...
                                                <polygon id="Tooth32" onclick="reply_click(this.id)" fill="white"
                                                    data-key="23"
                 ...
                 292,643.3 291.3,650 287,655 280.7,658.7 272,660 265,660.7 261.3,657.3 261.7,650 263.7,637 264.3,627 	">
                                                ...
                                                <polygon id="Tooth33" onclick="reply_click(this.id)" fill="white"
                                                    data-key="22"
                 ...
                 321,630 321.3,620.3 317,614.3 308,608 298.3,607 291,609.3 287,612.3 286.7,617.7 287.3,624.7 	">
                                                ...
                                                <polygon id="Tooth34" onclick="reply_click(this.id)" fill="white"
                                                    data-key="21"
                 ...
                 342.7,604 337.7,609 328,612.7 320,613.3 315,611 308.3,604.7 306.7,598 307.3,591.3 309,584.7 312.7,578.3 318.3,571.7 	">
                                                ...
                                                <polygon id="Tooth35" onclick="reply_click(this.id)" fill="white"
                                                    data-key="20"
                 ...
                 381.3,524.3 374,520.7 363.7,516.3 356.3,515.3 351.3,518.3 346.3,524 340.3,534.3 336,546.7 	">
                                                ...
                                                <path id="Tooth36" onclick="reply_click(this.id)" fill="white"
                                                    data-key="19"
                                                ...
                                                <polygon id="Tooth37" onclick="reply_click(this.id)" fill="white"
                                                    data-key="18"
                 ...
                 407.7,427.3 	">
                                                ...
                                                <polygon id="Tooth38" onclick="reply_click(this.id)" fill="white"
                                                    data-key="17"
                 ...
                 406.7,395 401,377.7 397.3,373 390.7,367.3 380,365 373,366.7 367.3,369 364,374.3 360,389 363.3,401.3 367.7,412.3 	">
                                                ...
                                                <polygon id="Tooth28" onclick="reply_click(this.id)" fill="white"
                                                    data-key="16"
                 ...
                 369,339.7 359,335 354.7,327.7 354.3,316 358.3,304 363.7,294 368.7,294.7 378.7,296 389,296 	">
                                                ...
                                                <polygon id="Tooth27" onclick="reply_click(this.id)" fill="white"
                                                    data-key="15"
                 ...
                 371,294.3 392,295 404.3,293.7 410,280.7 412,263.3 407.3,246.7 401,240.3 396,239.7 389.3,243 	">
                                                ...
                                                <polygon id="Tooth26" onclick="reply_click(this.id)" fill="white"
                                                    data-key="14"
                 ...
                 393,196 399.3,207 401.3,222.7 400,234.3 394.7,240.7 381.7,244.7 371,246 	">
                                                ...
                                                <polygon id="Tooth25" onclick="reply_click(this.id)" fill="white"
                                                    data-key="13"
                 ...
                 383.3,178.3 	">
                                                ...
                                                <polygon id="Tooth24" onclick="reply_click(this.id)" fill="white"
                                                    data-key="12"
                 ...
                 348.7,122.7 354.3,127.7 	">
                                                ...
                                                <polygon id="Tooth23" onclick="reply_click(this.id)" fill="white"
                                                    data-key="11"
                 ...
                 297.3,120.3 294,112 295.7,102.7 299,95 303.3,90 309.3,88 316.3,87.3 322.7,87.3 328,88.3 	">
                                                ...
                                                <polygon id="Tooth22" onclick="reply_click(this.id)" fill="white"
                                                    data-key="10"
                 ...
                 274.7,54.7 282,53 287.7,54.7 297.3,60.3 304,64.3 308.7,68.7 312.3,74 313,81 	">
                                                ...
                                                <polygon id="Tooth21" onclick="reply_click(this.id)" fill="white"
                                                    data-key="9"
                 ...
                 222,58.3 219,50 220,44.3 224.3,40.3 230,38.7 237.3,38.7 253,39.3 258.7,41.3 264.3,43.7 268.3,45.7 	">
                                                ...
                                                <polygon id="Tooth11" onclick="reply_click(this.id)" fill="white"
                                                    data-key="8"
                 ...
                 212.3,75.7 208,83 201.7,85.7 195.7,86.7 189.7,83.3 183.7,74.7 175,62 171.7,54 172.7,49.7 	">
                                                ...
                                                <path id="Tooth12" onclick="reply_click(this.id)" fill="white"
                                                    data-key="7"
                                                ...
                                                <polygon id="Tooth13" onclick="reply_click(this.id)" fill="white"
                                                    data-key="6"
                 ...
                 131.3,125 121,125 114.7,119.3 110.3,112.3 108.3,104.7 108.7,94.7 110.7,88.7 116,84 	">
                                                ...
                                                <polygon id="Tooth14" onclick="reply_click(this.id)" fill="white"
                                                    data-key="5"
                 ...
                 105.7,162.3 96.7,161 85.7,156 82,150 81,139.3 86.3,128 93,121.3 100.7,117.3 	">
                                                ...
                                                <polygon id="Tooth15" onclick="reply_click(this.id)" fill="white"
                                                    data-key="4"
                 ...
                 73.7,201 64.3,196.7 60.3,190.7 59,183.3 61.7,175.3 66.3,167.7 71.3,161.3 	">
                                                ...
                                                <path id="Tooth16" onclick="reply_click(this.id)" fill="white"
                                                    data-key="3"
                                                ...
                                                <polygon id="Tooth17" onclick="reply_click(this.id)" fill="white"
                                                    data-key="2"
                 ...
                 50.3,246.7 56,249 65.3,250.7 74,249.7 80.3,249.7 82.3,254 85.3,259.3 87,267.7 87.7,274.7 85.3,282.7 	">
                                                ...
                                                <polygon id="Tooth18" onclick="reply_click(this.id)" fill="white"
                                                    data-key="1"
                 ...
                 82,314.3 81.3,302 80.7,292.7 73.7,292 51.3,293.7 38.7,293.7 34,298 31.7,302.3 32,311 	">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <form id="saveOdontogram"
                                        action="{{ route('patient-details.odontogram', $patientDetail) }}"
                                        method="POST">
                                        <div class="timeline">
                                            @can('patient-detail-create')
                                                @csrf
                                                <input type="hidden" name="tooth" id="tooth">
                                                <div class="time-label">
                                                    <span class="bg-info">Today</span>
                                                </div>
                                                <div>
                                                    <i class="fas fa-tooth bg-blue"></i>
                                                    <div class="timeline-item">
                                                        <span class="time"></span>
                                                        <h3 class="timeline-header"><a href="#" id="selectTooth">Select
                                                                a tooth</a></h3>
                                                        <div class="timeline-body">
                                                            <textarea id="toothDetail" name="detail" class="form-control" maxlength="2000" placeholder=""></textarea>
                                                        </div>
                                            ...
                                            @foreach ($patientDetail->odontograms()->latest()->get() as $odo)
                                                <div class="time-label">
                                                    <span class="bg-info">{{ $odo->created_at->format('d M Y') }}</span>
                                                </div>
                                                <div>
                                                    <i class="fas fa-tooth bg-blue"></i>
                                                    <div class="timeline-item">
                                                        <span class="time"><i class="fas fa-clock"></i>
                                                            {{ $odo->created_at->format('H:i') }}</span>
                                                        <h3 class="timeline-header"><a>{{ $odo->tooth }}</a></h3>
                                                        <div class="timeline-body">{{ $odo->detail }}</div>
                                                        @can('patient-detail-create')
                                                            <div class="timeline-footer">
                                                                <a href="{{ route('patient-details.odontogram', $odo) }}"
                                                                    class="btn btn-danger btn-sm"
                                                                    onclick="return confirm('@lang('Are You Sure You Want To Delete This Data ???')')">Delete</a>
                                                            </div>
                                                        @endcan
                                                    </div>
                                                </div>
...
@push('footer')
    <script>
        function reply_click(tooth) {
            $('#selectTooth').html(tooth);
            $('#tooth').val(tooth);
        }

        $(document).on('submit', '#saveOdontogram', function(e) {
            let t = $('#tooth').val();
            let d = $('#toothDetail').val();
            if (!t.length || !d.length) {
                alert('Please select an tooth and provide some details!');
                e.preventDefault();
                return;
            }
        });
